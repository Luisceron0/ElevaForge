  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-forge-bg-dark px-4">
      <div className="text-center max-w-md">
        ...
        <Link
          href="/"
          className="inline-block bg-forge-orange-main hover:bg-forge-orange-gold text-forge-bg-dark font-bold py-3 px-8 rounded-xl transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-forge-orange-main focus:ring-offset-2 focus:ring-offset-forge-bg-dark"
        >
          Volver al inicio
        </Link>
      </div>
